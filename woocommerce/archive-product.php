...
?>
<header class="woocommerce-products-header wp-block-cover alignfull">
	...
	if ( $thumbnail_id ) {
		...
		echo wc_placeholder_img( 'large', array( 'class' => 'wp-block-cover__image-background' ) );
	}
	...
	<div class="wp-block-cover__inner-container alignnarrow">
		...
		<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
			<h1 class="woocommerce-products-header__title page-title mw-600"><?php woocommerce_page_title(); ?></h1>
		<?php endif; ?>
		...
		<?php if ( is_tax( 'product_cat' ) ) { ?>
			...
			<div class="wp-block-buttons">
				<div class="wp-block-button is-style-border-double">
					<a href="#mas-info" class="btn btn-primary"><?php echo __( 'Infórmate sin compromiso', 'smn' ); ?></a>
				</div>
			</div>
