...
function smn_acf_read_only_field( $field ) {
    ...
    $readonly_fields_group = 832;

    if( $readonly_fields_group === $field['parent'] ) {
        $field['readonly'] = 1;	
        $field['disabled'] = 1;	
    }
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label' => 'Descripción secundaria (bajo la cabecera)',
            ...
            array(
                ...
                'label' => 'Descripción terciaria (al pie)',
